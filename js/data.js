...
const allTeams = {
    ...
    "유벤투스": {
        ...
        players: [
            ...
            { name: "필리프 코스티치", position: "FW", country: "세르비아", age: 33, rating: 83 },
...
const freeAgentPool = [
    ...
    { name: "아론 히키", position: "DF", country: "스코틀랜드", rating: 80, age: 22 },
    ...
    { name: "배준호", position: "FW", country: "대한민국", rating: 75, age: 21 },
    { name: "오현규", position: "FW", country: "대한민국", rating: 75, age: 23 },
    { name: "엄지성", position: "FW", country: "대한민국", rating: 72, age: 22 },
    ...
    { name: "기성용", position: "MF", country: "대한민국", rating: 80, age: 37 },
];
...
const iconPlayersList = [
    ...
    { name: "필리프 람", position: "DF", country: "독일" },
    { name: "가린샤", position: "MF", country: "브라질" },
];

// 국제대회 참가국
const TOURNAMENT_TEAMS = {
    WORLD_CUP:    ["FRA","ENG","ESP","GER","POR","ITA","NED","BEL","CRO","DEN","SUI","AUT","POL","TUR","CZE","SWE","BRA","ARG","URU","COL","ECU","CHI","PAR","PER","KOR","JPN","KSA","AUS","IRN","QAT","UZB","IRQ","MAR","SEN","NGA","EGY","ALG","TUN","CMR","CIV","GHA","USA","MEX","CAN","CRC","PAN","JAM","NZL"],
    EURO:         ["FRA","ENG","ESP","GER","POR","ITA","NED","BEL","CRO","DEN","SUI","AUT","POL","TUR","CZE","SWE","UKR","SCO","HUN","SRB","SVK","SVN","ROU","GRE"],
    ASIAN_CUP:    ["KOR","JPN","AUS","IRN","KSA","QAT","UZB","JOR","UAE","OMN","CHN","SYR","VIE","THA","MAS","IDN","IND","TJK","LBN","PLE","BHR","KUW","PRK","KGZ"],
    COPA_AMERICA: ["BRA","ARG","URU","COL","ECU","CHI","PER","PAR","BOL","VEN"],
    AFCON:        ["MAR","SEN","NGA","EGY","ALG","TUN","CMR","CIV","GHA","MLI","RSA","BFA","COD","ANG","GUI","CPV","ZAM","BEN","UGA","TOG","GAB","CGO","LBY","SUD"],
};

// 국가코드 매핑
const COUNTRY_CODE_MAP = {
    "대한민국":"KOR","일본":"JPN","호주":"AUS","이란":"IRN","사우디아라비아":"KSA","카타르":"QAT",
    "우즈베키스탄":"UZB","이라크":"IRQ","프랑스":"FRA","잉글랜드":"ENG","스페인":"ESP","독일":"GER",
    "포르투갈":"POR","이탈리아":"ITA","네덜란드":"NED","벨기에":"BEL","크로아티아":"CRO","덴마크":"DEN",
    "스위스":"SUI","오스트리아":"AUT","폴란드":"POL","튀르키예":"TUR","체코":"CZE","스웨덴":"SWE",
    "우크라이나":"UKR","스코틀랜드":"SCO","헝가리":"HUN","세르비아":"SRB","브라질":"BRA",
    "아르헨티나":"ARG","우루과이":"URU","콜롬비아":"COL","에콰도르":"ECU","칠레":"CHI",
    "파라과이":"PAR","페루":"PER","모로코":"MAR","세네갈":"SEN","나이지리아":"NGA","이집트":"EGY",
    "알제리":"ALG","튀니지":"TUN","카메룬":"CMR","코트디부아르":"CIV","가나":"GHA",
    "미국":"USA","멕시코":"MEX","캐나다":"CAN","노르웨이":"NOR","러시아":"RUS","그리스":"GRE",
    "루마니아":"ROU","슬로바키아":"SVK","슬로베니아":"SVN","요르단":"JOR","북아일랜드":"NIR",
    "코소보":"KOS","아르메니아":"ARM","알바니아":"ALB","몬테네그로":"MNE","조지아":"GEO",
};
